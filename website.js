...
function sendChatMessage(event) {
  ...
  function getDynamicFrontendFallback(text) {
    ...
    if (/\d{12}|\d{6}-\d{2}-\d{4}|ic saya|no ic|nombor ic|931119105869/.test(q)) {
      ...
      return "Eh tak tipu tau! Kadar faedah 2.77% p.a. tu memang wujud dan SAH di bawah Pembiayaan Peribadi-i Bank Muamalat (Cash-i)! 😊 (Maksud Wani kadar rasmi ialah 2.77% p.a. tau, bukannya 2.777% hehe!).\n\n📌 FAKTA SEBENAR KADAR BANK MUAMALAT:\n• Kadar 2.77% p.a. ialah kadar SERENDAH (starting rate) untuk pembiayaan sehingga 10 tahun (0 penjamin / 0 yuran pemprosesan).\n• Kadar sebenar tertakluk kepada sektor pekerjaan & profil kredit (kakitangan awam/GLC/panel EEP layak kadar 2.77%, manakala sektor swasta lain biasanya antara 3.5% hingga 11% p.a. mengikut penilaian kredit bank).\n\n🔗 SEMAK BUKTI RASMI DI PORTAL BANK MUAMALAT:\nAwak boleh semak helaian maklumat produk rasmi terus di laman web Bank Muamalat: https://map.muamalat.com.my atau https://www.muamalat.com.my\n\nHaa awak kerja sektor swasta ke kerajaan sekarang? Biar Wani tolong angarkan kadar yang sesuai untuk profil awak!";
